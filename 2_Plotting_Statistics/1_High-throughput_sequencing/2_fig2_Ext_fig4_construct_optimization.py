...
### boxplot fig2, extended fig4 pmcDA-APOBEC ###
...
### targeted region ###
NGSmutation_frequency_v2(["CtoT"],namelist,filelist_temp,"Set21_PmAPO_opt_Cyc4_summary_average_mutrange",[443,547],width=3,graphmod="Box",color_list=blue1,legend=False,outtype="pdf")
NGSmutation_frequency_v2(["GtoA"],namelist,filelist_temp,"Set21_PmAPO_opt_Cyc4_summary_average_mutrange",[443,547],width=3,graphmod="Box",color_list=blue2,legend=False,outtype="pdf")
NGSmutation_frequency_v2(["AtoG"],namelist,filelist_temp,"Set21_PmAPO_opt_Cyc4_summary_average_mutrange",[443,547],width=3,graphmod="Box",color_list=red1,legend=False,outtype="pdf")
NGSmutation_frequency_v2(["TtoC"],namelist,filelist_temp,"Set21_PmAPO_opt_Cyc4_summary_average_mutrange",[443,547],width=3,graphmod="Box",color_list=red2,legend=False,outtype="pdf")

### untargeted region  ###
NGSmutation_frequency_v2(["CtoT"],namelist,filelist_temp,"Set21_PmAPO_opt_Cyc4_summary_average_mutrange",[321,442,548,562],width=3,graphmod="Box",color_list=blue1,legend=False,outtype="pdf")
NGSmutation_frequency_v2(["GtoA"],namelist,filelist_temp,"Set21_PmAPO_opt_Cyc4_summary_average_mutrange",[321,442,548,562],width=3,graphmod="Box",color_list=blue2,legend=False,outtype="pdf")
NGSmutation_frequency_v2(["AtoG"],namelist,filelist_temp,"Set21_PmAPO_opt_Cyc4_summary_average_mutrange",[321,442,548,562],width=3,graphmod="Box",color_list=red1,legend=False,outtype="pdf")
NGSmutation_frequency_v2(["TtoC"],namelist,filelist_temp,"Set21_PmAPO_opt_Cyc4_summary_average_mutrange",[321,442,548,562],width=3,graphmod="Box",color_list=red2,legend=False,outtype="pdf") 
...
### untargeted region  ###
NGSmutation_frequency_v2(["CtoT"],namelist,filelist_temp,"Set21_TadDE_opt_Cyc4_summary_average_mutrange",[321,442,548,562],width=3,graphmod="Box",color_list=blue1,legend=False,outtype="pdf")
NGSmutation_frequency_v2(["GtoA"],namelist,filelist_temp,"Set21_TadDE_opt_Cyc4_summary_average_mutrange",[321,442,548,562],width=3,graphmod="Box",color_list=blue2,legend=False,outtype="pdf")
NGSmutation_frequency_v2(["AtoG"],namelist,filelist_temp,"Set21_TadDE_opt_Cyc4_summary_average_mutrange",[321,442,548,562],width=3,graphmod="Box",color_list=red1,legend=False,outtype="pdf")
NGSmutation_frequency_v2(["TtoC"],namelist,filelist_temp,"Set21_TadDE_opt_Cyc4_summary_average_mutrange",[321,442,548,562],width=3,graphmod="Box",color_list=red2,legend=False,outtype="pdf")    
